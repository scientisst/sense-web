...
var d3 = false;
Promise.resolve().then(function () { return __importStar(require("d3")); }).then(function (d3Module) {
    d3 = d3Module;
});
var defaultMargins = {
    top: 0,
...
var useLiveD3Chart = function (_a) {
    ...
    var _b = (0, react_1.useState)(null), chartNode = _b[0], setChartNode = _b[1];
    var _c = (0, react_1.useState)(null), parentElement = _c[0], setParentElement = _c[1];
    var _d = (0, react_1.useState)(null), canvasElement = _d[0], setCanvasElement = _d[1];
    ...
    var _h = (0, react_1.useState)([]), downsampledData = _h[0], setDownsampledData = _h[1];
    var _j = (0, react_1.useState)([]), data = _j[0], setData = _j[1];
    var _k = (0, react_1.useState)(null), downsamplerWorker = _k[0], setDownsamplerWorker = _k[1];
    var downsamplerWorkerReady = (0, react_1.useRef)(true);
    var dataLastOriginal = (0, react_1.useRef)(0);
    var dataLastDownsampled = (0, react_1.useRef)(0);
    var _l = (0, react_1.useState)(true), requiresDownsampling = _l[0], setRequiresDownsampling = _l[1];
    var lastDownsampling = (0, react_1.useRef)(0);
    var redraw = (0, react_1.useCallback)(function () {
    ...
    (0, react_1.useEffect)(function () {
        setChartNode((0, jsx_runtime_1.jsx)("div", __assign({ ref: setParentElement, className: (0, clsx_1.default)("relative", className), style: style }, { children: (0, jsx_runtime_1.jsx)("canvas", { ref: setCanvasElement, className: "h-auto w-full", style: style }) })));
    }, [className, style]);
    (0, react_1.useEffect)(function () {
        var cancel = false;
    ...
    var setDataExport = (0, react_1.useCallback)(function (newData) {
        setData(newData);
        setRequiresDownsampling(true);
        dataLastOriginal.current = -1;
    }, []);
    var appendDataExport = (0, react_1.useCallback)(function (newData) {
...
exports.default = useLiveD3Chart;
